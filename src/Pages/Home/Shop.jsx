    ...
    <div className="flex flex-col md:flex-row items-center gap-2 mt-2">
      ...
      <div className="md:w-[50%] flex-1 shrink-0 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-between">
          ...
          <div className="mb-9">
            <Button className="bg-white text-black px-5 py-6 font-medium" onClick={() => navigate('/men')}>Explore Collections</Button>
          </div>
        </div>
      </div>
      ...
      <div className="md:w-[50%] flex-1 shrink-0 relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-between">
          ...
          <div className="mb-9">
            <Button className="bg-white text-black px-5 py-6 font-medium" onClick={() => navigate('/women')}>Explore Collections</Button>
          </div>
        </div>
      </div>
